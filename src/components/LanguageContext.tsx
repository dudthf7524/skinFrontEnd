...
const translations = {
  ko: {
    ...
    diagnosis_expectedDiagnosis: "예상 진단",
    ...
    diagnosis_emailDescription: "상세한 진단 리포트와 관리 가이드를 이메일로 받아보세요",
    ...
    diagnosis_emailSentSuccess: "진단 결과가 {email}로 전송되었습니다",
    ...
    // Home page
    home_aiScreeningService: "AI 피부 질병 스크리닝 서비스",
    home_mainTitle: "반려동물 피부 건강을 AI로 진단하세요",
    home_mainDescription: "반려동물의 피부 사진을 업로드하거나 AI 진단을 즉시 시작하세요",
    ...
    home_step1Description: "반려동물의 피부 문제 부위를 사진으로 촬영하여 업로드하세요.",
    home_step2Title: "AI 분석",
    home_step2Description: "고도화된 AI가 피부 상태를 분석하여 질병 가능성을 진단합니다.",
    home_step3Title: "병원 연결",
    home_step3Description: "분석 결과를 바탕으로 주변 전문 병원을 추천하고 예약을 도와드립니다.",
    home_analysisTime: "💡 평균 분석 시간: 30초 이내",
    home_whyChooseTitle: "왜 Talktail SkinCare AI를 선택해야 할까요?",
    home_whyChooseSubtitle: "전문적이고 신뢰할 수 있는 반려동물 피부 진단 서비스",
    home_feature1Title: "95% 높은 정확도",
    home_feature1Description: "수만 건의 데이터로 학습한 AI 알고리즘",
    home_feature2Title: "전문 수의사 연결",
    home_feature2Description: "500+ 제휴 병원과 즉시 연결",
  ...
  en: {
    ...
    home_step1Description: "Take and upload a photo of your pet's skin problem area.",
    ...
    home_whyChooseTitle: "Why should you choose Talktail SkinCare AI?",
    home_whyChooseSubtitle: "Professional and reliable pet skin diagnosis service",
    home_feature1Title: "95% High Accuracy",
    home_feature1Description: "AI algorithm trained on tens of thousands of data",
    home_feature2Title: "Professional Veterinarian Connection",
    ...
    home_footerDescription: "Smart solution that protects your pet's skin health with AI technology. Get better treatment through connection with professional veterinarians.",
    home_footerAccuracy: "95% Accuracy",
  ...
  ja: {
    ...
    home_step1Description: "ペットの皮膚問題部位を写真で撮影してアップロードしてください。",
    ...
    home_whyChooseTitle: "なぜTalktail SkinCare AIを選ぶべきでしょうか？",
    home_whyChooseSubtitle: "専門的で信頼できるペット皮膚診断サービス",
    home_feature1Title: "95%の高い精度",
    home_feature1Description: "数万件のデータで学習したAIアルゴリズム",
    home_feature2Title: "専門獣医師接続",
    ...
    home_footerDescription: "AI技術でペットの皮膚健康を守るスマートソリューションです。専門獣医師との接続を通じてより良い治療を受けましょう。",
  ...
  zh: {
    ...
    home_step1Description: "拍摄并上传宠物皮肤问题部位的照片。",
    home_step2Title: "AI分析",
    ...
    home_whyChooseTitle: "为什么要选择Talktail SkinCare AI？",
    home_whyChooseSubtitle: "专业可靠的宠物皮肤诊断服务",
    home_feature1Title: "95%高精度",
    home_feature1Description: "用数万条数据训练的AI算法",
    home_feature2Title: "专业兽医连接",
    ...
    home_footerDescription: "用AI技术守护宠物皮肤健康的智能解决方案。通过与专业兽医的连接获得更好的治疗。",
