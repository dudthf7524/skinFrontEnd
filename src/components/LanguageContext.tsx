...
const translations = {
  ko: {
    ...
    upload_diagnosisDescription: "이미지가 224x224 크기로 최적화되었습니다. AI 진단을 시작하세요.",
    upload_startDiagnosis: "진단하기",
    upload_guideTitle: "촬영 가이드",
    upload_guideNaturalLight: "밝은 자연광에서 촬영해 주세요",
    upload_guideClearCapture: "병변 부위를 선명하게 포착해 주세요",
    upload_guideCloseUp: "흔들림 없이 근접 촬영해 주세요",
    upload_cropModalTitle: "이미지 크롭",
    upload_cropModalDescription: "병변 부위를 정사각형 영역으로 선택해주세요. 최종 이미지는 224x224 크기로 변환됩니다.",
    upload_cancel: "취소",
    upload_cropComplete: "크롭 완료",
    upload_previousStep: "이전 단계로",
  ...
  en: {
    ...
    upload_diagnosisDescription: "Image has been optimized to 224x224 size. Start AI diagnosis.",
    upload_startDiagnosis: "Start Diagnosis",
    upload_guideTitle: "Photography Guide",
    upload_guideNaturalLight: "Please shoot in bright natural light",
    upload_guideClearCapture: "Capture the lesion area clearly",
    upload_guideCloseUp: "Take close-up shots without shaking",
    upload_cropModalTitle: "Image Crop",
    upload_cropModalDescription: "Please select the lesion area as a square region. The final image will be converted to 224x224 size.",
    upload_cancel: "Cancel",
    upload_cropComplete: "Crop Complete",
    upload_previousStep: "Previous Step",
  ...
  ja: {
    ...
    upload_diagnosisDescription: "画像が224x224サイズに最適化されました。AI診断を開始してください。",
    upload_startDiagnosis: "診断開始",
    upload_guideTitle: "撮影ガイド",
    upload_guideNaturalLight: "明るい自然光で撮影してください",
    upload_guideClearCapture: "病変部位を鮮明に撮影してください",
    upload_guideCloseUp: "ブレずに近接撮影してください",
    upload_cropModalTitle: "画像クロップ",
    upload_cropModalDescription: "病変部位を正方形領域で選択してください。最終画像は224x224サイズに変換されます。",
    upload_cancel: "キャンセル",
    upload_cropComplete: "クロップ完了",
    upload_previousStep: "前のステップへ",
  ...
  zh: {
    ...
    upload_diagnosisDescription: "图像已优化为224x224尺寸。开始AI诊断。",
    upload_startDiagnosis: "开始诊断",
    upload_guideTitle: "拍摄指南",
    upload_guideNaturalLight: "请在明亮的自然光下拍摄",
    upload_guideClearCapture: "请清晰地拍摄病变部位",
    upload_guideCloseUp: "请近距离拍摄，避免晃动",
    upload_cropModalTitle: "图像裁剪",
    upload_cropModalDescription: "请将病变部位选择为正方形区域。最终图像将转换为224x224尺寸。",
    upload_cancel: "取消",
    upload_cropComplete: "裁剪完成",
    upload_previousStep: "上一步",
